...
const report: Report = {
  ...
  highlighted_papers: [
    ...
    },
    {
      paper_id: historicalPaperId,
      paper_version_id: historicalPaperVersionId,
      title: "A Failed Parser Fixture",
      reason: "Author abstract remains available while structured analysis is unavailable.",
      evidence_ids: [],
    },
  ],
  major_entities: [
...
const run = {
  ...
  publication_outcome: "UPDATE" as const,
...
const runItems = [
  {
    ...
    paper_abstract: "A source-grounded agent memory system.",
    source_url: "https://arxiv.org/abs/2608.01234v1",
    analysis_status: "AVAILABLE" as const,
    related_work_status: "AVAILABLE" as const,
    related_work_reason: null,
    comparison_status: "LIMITED_COMPARABILITY" as const,
    comparison_reason: "The evaluation scopes differ.",
    trend_status: "AVAILABLE" as const,
  ...
  },
  {
    ...
    paper_abstract: "A paper whose metadata remains usable after parser failure.",
    source_url: "https://arxiv.org/abs/2608.05678v1",
    analysis_status: "ANALYSIS_UNAVAILABLE" as const,
    related_work_status: "RELATED_WORK_UNAVAILABLE" as const,
    related_work_reason: "ANALYSIS_UNAVAILABLE",
    comparison_status: "COMPARISON_UNAVAILABLE" as const,
    comparison_reason: "NO_COMPATIBLE_HISTORICAL_ANALYSIS",
    trend_status: "INSUFFICIENT_DATA" as const,
